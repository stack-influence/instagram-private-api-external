...
export declare class UploadRepository extends Repository {
  ...
  videoSegmentInit(
    options: UploadVideoSegmentInitOptions,
  ): Promise<{
    offset: number;
  }>;
  videoSegmentTransfer(options: UploadVideoSegmentTransferOptions): Promise<any>;
  endSegmentedVideo({ ruploadParams, streamId }: { ruploadParams: any; streamId: any }): Promise<any>;
  private getBaseHeaders;
  private static createPhotoRuploadParams;
  static createVideoRuploadParams(
