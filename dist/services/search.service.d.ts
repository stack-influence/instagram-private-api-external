...
export declare class SearchService extends Repository {
  ...
  blendedItems(
    ...
    (
      | import('..').FbsearchRepositoryTopsearchFlatResponsePlace
      | import('..').FbsearchRepositoryTopsearchFlatResponseHashtag
      | import('..').FbsearchRepositoryTopsearchFlatResponseUser
    )[]
  >;
  ...
  location(
    ...
    longitude: number,
    query?: string,
  ): Promise<import('..').LocationRepositorySearchResponseVenuesItem[]>;
}
